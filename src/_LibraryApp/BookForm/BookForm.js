...
class BookForm extends Component {
  ...
  render() {
    ...
    return (
      <form className="form book-form" onSubmit={this.handleSubmit.bind(this)}>
        ...
        <div className="form-element">
          ...
          <div className="book-status">
            ...
            ></div>
            <div className="text" id="read">
              Przeczytana
            </div>
            <div
              className="box unread"
              onClick={this.handleClick.bind(this)}
            ></div>
            <div className="text" id="unread">
              Nieprzeczytana
            </div>
            <div
              ...
              onClick={this.handleClick.bind(this)}
            ></div>
            <div className="text" id="in-progress">
              W trakcie czytania
            </div>
          </div>
        </div>

        <Rating show={rating} handleRating={this.handleRating} />

        <button className="book-form-btn" type="submit">
          DODAJ KSIAŻKĘ
        </button>
      </form>
    );
